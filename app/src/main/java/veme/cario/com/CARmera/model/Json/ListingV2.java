...
public class ListingV2 {
    ...
    public String getExteriorGenericColor() {
        return exteriorGenericColor;
    }

    public void setExteriorGenericColor(String exteriorGenericColor) {
        this.exteriorGenericColor = exteriorGenericColor;
    }

    public String getInteriorGenericColor() {
        return interiorGenericColor;
    }

    public void setInteriorGenericColor(String interiorGenericColor) {
        this.interiorGenericColor = interiorGenericColor;
    }
    ...
    public List<String> getCarfaxes() {
        return carfaxes;
    }

    public void setCarfaxes(List<String> carfaxes) {
        this.carfaxes = carfaxes;
    }
