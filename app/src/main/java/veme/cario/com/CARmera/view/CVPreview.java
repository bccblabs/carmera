...
public class CVPreview extends CameraBridgeViewBase implements PreviewCallback {

    private static final int MAGIC_TEXTURE_ID = 10;
    private static final String TAG = "CVPreview";
    ...
    public CVPreview(Context context, int cameraId) {
        super(context, cameraId);
    }

    public CVPreview(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
