...
public class CustomerReviewFragment extends Fragment {
    ...
    private ListView customer_reviews;
    ...
    private void initUIComponents () {
        ...
        customer_reviews = (ListView) getView().findViewById(R.id.customer_list_view);
        reviewListAdapter = new ReviewListAdapter(getActivity());
        customer_reviews.setAdapter(reviewListAdapter);

        no_customer_review = (TextView) getView().findViewById(R.id.no_customer_review);
        customer_reviews.setEmptyView(no_customer_review);
        performRequest();
    }
}
