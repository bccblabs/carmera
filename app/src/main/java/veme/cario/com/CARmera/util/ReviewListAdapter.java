...
public class ReviewListAdapter extends ArrayAdapter<CustomerReview> {
    ...
    private static class ViewHolder {
        ...
        TextView average_rating_textview;
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder.average_rating_textview = (TextView) view.findViewById(R.id.review_average_rating);
            view.setTag(holder);
        } else {
        ...
        TextView average_rating_textview = holder.average_rating_textview;
        ...
        average_rating_textview.setText(review.getAverageRating());
