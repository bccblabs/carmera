...
public class Ratings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (src_data.rating_fun_to_drive != null && src_data.rating_fun_to_drive > 0) {
            StaggeredCardTwoLines StaggeredCardTwoLines = new StaggeredCardTwoLines(getActivity(), getString(R.string.rating_fun_to_drive), src_data.rating_fun_to_drive + " / 5", R.drawable.card_bgd0);
            cards.add(StaggeredCardTwoLines);
        }
        if (src_data.rating_build_quality != null && src_data.rating_build_quality > 0) {
            StaggeredCardTwoLines StaggeredCardTwoLines = new StaggeredCardTwoLines(getActivity(), getString(R.string.rating_build_quality), src_data.rating_build_quality + " / 5", R.drawable.card_bgd0);
            cards.add(StaggeredCardTwoLines);
        }
        if (src_data.rating_comfort != null && src_data.rating_comfort > 0) {
            StaggeredCardTwoLines StaggeredCardTwoLines = new StaggeredCardTwoLines(getActivity(), getString(R.string.rating_comfort), src_data.rating_comfort + " / 5", R.drawable.card_bgd0);
            cards.add(StaggeredCardTwoLines);
        }
        if (src_data.rating_performance != null && src_data.rating_performance > 0) {
            StaggeredCardTwoLines StaggeredCardTwoLines = new StaggeredCardTwoLines(getActivity(), getString(R.string.rating_performance), src_data.rating_performance + " / 5", R.drawable.card_bgd0);
            cards.add(StaggeredCardTwoLines);
        }
        if (src_data.rating_reliability != null && src_data.rating_reliability > 0) {
            StaggeredCardTwoLines StaggeredCardTwoLines = new StaggeredCardTwoLines(getActivity(), getString(R.string.rating_reliability), src_data.rating_reliability + " / 5", R.drawable.card_bgd0);
            cards.add(StaggeredCardTwoLines);
        }
        if (src_data.rating_int != null && src_data.rating_int > 0) {
            StaggeredCardTwoLines StaggeredCardTwoLines = new StaggeredCardTwoLines(getActivity(), getString(R.string.rating_int), src_data.rating_int + " / 5", R.drawable.card_bgd0);
            cards.add(StaggeredCardTwoLines);
        }

        if (src_data.rating_ext != null && src_data.rating_ext > 0) {
            StaggeredCardTwoLines StaggeredCardTwoLines = new StaggeredCardTwoLines(getActivity(), getString(R.string.rating_ext), src_data.rating_ext + " / 5", R.drawable.card_bgd0);
            cards.add(StaggeredCardTwoLines);
        }
