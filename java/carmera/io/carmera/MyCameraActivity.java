 ...
 */
public class MyCameraActivity extends AppCompatActivity implements RevealBackgroundView.OnStateChangeListener,
        CameraHostProvider {
    ...
    public static void startCameraFromLocation(int[] startingLocation, Activity startingActivity) {
        Intent intent = new Intent(startingActivity, MyCameraActivity.class);
...
//        PublishActivity.openWithPhotoUri(this, Uri.fromFile(photoPath));
    ...
    private void updateState(int state) {
        ...
        if (currentState == STATE_TAKE_PHOTO) {
            ...
            vUpperPanel.setInAnimation(this, R.anim.slide_out_to_right);
            vLowerPanel.setInAnimation(this, R.anim.slide_out_to_right);
